...
public class CardPayVerify extends UssdActionClassInterface {
  static Logger l = (new CardPayVerify()).doLog();
  ...
  public static void main(String[] args) {
    ...
    System.out.println((new CardPayVerify()).processIntermediateAction(json));
  }
  
  private String checkCustDetails(String phoneNo, String biller, String subscId, String otherInfo) {
    String name = "NORESULT";
    try {
      String url = "http://172.16.30.19:8787/VerifyBill/?alias=" + biller + "&account=" + subscId + "&phone=" + phoneNo + "&otherinfo=" + otherInfo;
      String rslt = "";
      try {
        rslt = doRequest(url);
      } catch (Exception e) {
  ...
  public TreeMap<String, String> processIntermediateAction(String jsonData) {
    ...
    try {
      ...
      String biller = m.get("VASTYPE");
      String subscriberId = m.get("DESTACCT");
      ...
      String rst = checkCustDetails(mn, biller, subscriberId, extras);
