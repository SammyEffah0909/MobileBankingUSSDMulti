    ...
    public TreeMap<String, String> processIntermediateAction(String jsonData) {
        ...
        try {
            ...
            if (rst[0].equals("true")) {
                ...
                f.put("TMSG", "Your details do not match our record,~ Please visit the nearest " + bankName + " branch to regularise. Thank you");
                f.put("1", "");
            }
        } catch (Exception e) {
            l.error(e, e);
